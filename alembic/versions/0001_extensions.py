...
ENUMS: dict[str, tuple[str, ...]] = {
    ...
    "ingest_status": (
        "pending", "fetching", "extracting", "chunking", "embedding",
    ...
    "answer_state": (
        "grounded", "partially_grounded", "conflict", "insufficient_evidence",
        "clarification_needed", "out_of_scope", "refused_safety", "error",
    ),
